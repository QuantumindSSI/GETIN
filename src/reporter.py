...
def start_scheduler(bot: Bot) -> AsyncIOScheduler:
    """Start the APScheduler for recurring reports."""
    scheduler = AsyncIOScheduler(timezone="UTC")

    @scheduler.scheduled_job("interval", hours=6, id="six_hour_report")
    ...
    @scheduler.scheduled_job("cron", hour=9, minute=0, id="daily_free_report")
    async def free_daily_report():
